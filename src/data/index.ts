...
const diegoPrices = [
  ...
  { name: 'Depilação nasal', value: 24.9 },
  { name: 'Terapia Cone hindu', value: 44.99 },
  { name: 'Massagem facial express', value: 19.9 },
  { name: 'Limpeza facial premium', value: 54.9 },
]

export const samuelPedroPrices = [
  { name: 'Corte', value: 45 },
  ...diegoPrices
    .map((s, i) => ({
      ...s,
...
export const variablePrices = ['Luzes', 'Selagem', 'Alisamento capilar']
...
export const services: Service[] = [
  {
    ...
    description:
      'Transforme seu visual com um corte de cabelo feito sob medida para realçar sua personalidade.',
    image: corte,
    duration: 40,
  },
  {
    ...
    icon: require('../assets/svgs/barber-brush-svgrepo-com.svg'),
    description:
      'Agilidade e estilo em um serviço rápido e preciso de barbear.',
    image: barba,
    duration: 40,
  },
  {
    ...
    icon: require('../assets/svgs/barber-brush-svgrepo-com.svg'),
    description:
      'Relaxe enquanto cuidamos da sua barba, proporcionando uma experiência revigorante.',
    image: barboterapia,
    duration: 40,
  },
  {
    ...
    icon: require('../assets/svgs/barber-brush-svgrepo-com.svg'),
    description:
      'Destaque seu olhar com um serviço especializado em designer de sobrancelhas masculinas.',
    image: sobrancelha,
    duration: 40,
  },
  {
    ...
    icon: require('../assets/svgs/barber-brush-svgrepo-com.svg'),
    description:
      'Refine seu estilo com um acabamento preciso, incluindo detalhes no contorno.',
    image: Acabamento,
    duration: 40,
  },
  {
    ...
    icon: require('../assets/svgs/barber-brush-svgrepo-com.svg'),
    description:
      'Cuidado e estilo para os pequenos, proporcionando cortes adaptados às crianças.',
    image: kids,
    duration: 40,
  },
  {
    ...
    icon: require('../assets/svgs/barber-brush-svgrepo-com.svg'),
    description:
      'Restaure o brilho e força dos seus cabelos com nossos tratamentos de hidratação profunda.',
    image: hidratacao,
    duration: 40,
  },
  {
    ...
    icon: require('../assets/svgs/barber-brush-svgrepo-com.svg'),
    description:
      'Restaure a vitalidade da sua barba com nossos tratamentos de hidratação profunda.',
  ...
  },
  {
    ...
    name: 'Selagem',
    description:
      'Devolve o brilho, resistência e maciez para seus fios, alisando e fortalecendo seus cabelos.',
    image: selagem,
    duration: 40,
  },
  {
    ...
    description:
      'Alise e reduza o volume de seus fios, eliminando a necessidade do uso de chapinhas ou outros métodos de alisamentos temporários.',
    image: alisamento,
    duration: 40,
  },
  {
    ...
    description:
      'Revitalize mente e corpo com a terapia cone hindu, uma experiência única de bem-estar.',
    image: Cone,
    duration: 40,
  },
  {
    ...
    icon: require('../assets/svgs/barber-brush-svgrepo-com.svg'),
    description:
      'Utilizando técnicas seguras e eficazes, remova os pelos indesejados da narina, garantindo conforto e higiêne.',
    image: Nasal,
    duration: 40,
  },
  {
    ...
    name: 'Luzes',
    description:
      'Ilumine seu visual com destaques precisos de cores que complementam seu estilo.',
    image: Luzes,
    duration: 40,
  },
  {
    ...
    description:
      'Remove impurezas, controla a oleosidade e proporciona uma sensação de frescor e renovação.',
    image: limpeza,
    duration: 40,
  },
]
...
export const plans: Plan[] = [
  {
    name: 'Econômico',
    source:
      'https://celcash.celcoin.com.br/landingpage3865984/principal/assinar/economy/19',
    price: 89.9,
    description: 'Corte ilimitado Seg a Qua',
    benefits: [
      {
  ...
  },
  {
    name: 'Básico',
    source:
      'https://celcash.celcoin.com.br/landingpage3865984/principal/assinar/gold/15',
    price: 119.9,
    description: 'Corte ilimitado Seg a Sáb',
    benefits: [
      {
        name: 'Corte ilimitado (seg a sábado)',
        active: false,
      },
      {
        name: 'Barba ilimitada (seg a sábado)',
        active: false,
      },
      {
        name: 'Acabamento pezinho (seg a sábado)',
        active: false,
      },
      {
        name: 'Corte ilimitado',
  ...
  },
  {
    name: 'Intermediário',
    source:
      'https://celcash.celcoin.com.br/landingpage3865984/principal/assinar/prime/18',
    price: 144.9,
    description: 'Corte + Barba ilimitado Seg a Qua',
    benefits: [
      {
        name: 'Corte ilimitado (seg a quarta)',
        active: true,
...

  {
    name: 'Executivo',
    source:
      'https://celcash.celcoin.com.br/landingpage3865984/principal/assinar/black/17',
    price: 219.9,
    description: 'Corte + Barba ilimitado Seg a Sáb.',
    benefits: [
      {
        name: 'Corte ilimitado (seg a sábado)',
        active: false,
  ...
  },
  {
    name: 'Essencial',
    source:
      'https://celcash.celcoin.com.br/landingpage3865984/principal/assinar/platinum/16',
    price: 109.9,
    description: 'Barba Express ilimitada',
    benefits: [
      {
        name: 'Corte ilimitado',
        active: false,
